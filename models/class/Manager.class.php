<?php
	class Manager extends Connect{
		...
		public function insert_common($table, $data, $query_extra=NULL){
		...
		public function select_common($table, $fields, $filters, $query_extra=NULL){
		...
		public function delete_common($table, $filters, $query_extra=null){
		...
		}//fechando o método DIRECT QUERY
