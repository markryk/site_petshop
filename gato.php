	...
	<div id="interface">
		<header id="cabecalho">
			...
			<figure class="figcabecalho">
				<img src="_img/gatos.jpg">
			</figure>
		</header>

		<nav id="menu">
			<ul>
				<h1>Produtos para o seu gato</h1>
				<li>
					<button class="btn_a">
						<a href="cachorro.php"><i class="fas fa-dog"></i> Confira também ofertas para seu cachorro </a>
					</button>
				</li>
			</ul>
		</nav>
		...
		<ul id="produtos-gato">
			<li style="text-decoration: none;" class="produto" id="produto01"><a href="?cat=racao&an=cat"> Rações </a></li>
			<li style="text-decoration: none;" class="produto" id="produto02"><a href="?cat=higiene&an=cat"> Higiene </a></li>
			<li style="text-decoration: none;" class="produto" id="produto03"><a href="?cat=remedio&an=cat"> Remédios </a></li>
			<li style="text-decoration: none;" class="produto" id="produto04"><a href="?cat=acessorio&an=cat"> Acessórios </a></li>
		</ul>
		<br>
		...
		<footer id="rodape">
			...
			<p>Copyright &copy; 2018 - by <a href="https://github.com/markryk/"> Mark Ryk </a></p>
		</footer>
	</div>
